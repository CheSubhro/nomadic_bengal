				...
				<div class="template-demo">
					<nav aria-label="breadcrumb">
						<ol class="breadcrumb breadcrumb-custom bg-inverse-primary">
				            ...
				            <li class="breadcrumb-item active" aria-current="page"><span>All Destination Category</span></li>
						</ol>
					</nav>
				</div>
				<a href="<?= base_url();?>superpanel/destination_category/add"><button type="button" class="btn btn-outline-success btn-sm" id="add_new">Add New</button></a>
			</div>
		</div>
		<div class="card">
			<div class="card-body">
				<h4 class="card-title">Destination Category</h4>
				<div class="row">
					<div class="table-responsive">
						<table id="order-listing" class="table">
							...
							<tbody>
								<?php $i=1; foreach ($destination_category as $dc){?>
								<tr>
									<td><?= $i;?></td>
                    				<td><?= $dc->name;?></td>
                    				<td><?= $dc->title;?></td>
									...
									<td>
										<a href="<?= base_url();?>superpanel/destination_category/edit/<?= $dc->id;?>"><button type="button" class="btn btn-outline-primary btn-sm">Edit</button></a>
									    <a href="<?= base_url();?>superpanel/destination_category/delete/<?= $dc->id;?>" onclick="return confirm('Are you sure about this delete?');"><button type="button" class="btn btn-outline-danger btn-sm">Delete</button></a>
									</td>
								</tr>
								<?php $i++; }?>
							</tbody>
          			...
          			<div class="col-md-12">
            			<div class="form-group row">
              				...
              				<div class="col-md-6">
	                            ...
	                            <div class="col-sm-9">
	                                <div class="form-control"><?=$dc->description ?></div>
	                            </div>
              				</div>
              				<div class="col-md-6">
