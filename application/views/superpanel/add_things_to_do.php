				...
				<div class="template-demo">
					<nav aria-label="breadcrumb">
						<ol class="breadcrumb breadcrumb-custom bg-inverse-primary">
				            ...
				            <li class="breadcrumb-item active" aria-current="page"><span>Add Things To Do</span></li>
						</ol>
					</nav>
				</div>&nbsp;
				<h1 class="card-title alert alert-success text-center" align="center"><b>Add Things To Do</b></h1>
			</div>
		</div>
		<div class="card">
			<div class="card-body">
				<div class="row">
					<div class="col-lg-12">
						<form class="forms-sample" method="post" enctype="multipart/form-data"  action="<?= base_url();?>superpanel/things_to_do/insert">
							<div class="form-group">
					            ...
					            <select class="js-example-basic-single" style="width:100%" name="things_to_do_category_id">
					              ...
					              <?php foreach($things_to_do_category as $tc){?>
				            ...
				            <div class="form-group">
            					...
            					<textarea id='tinyMceExample'  name="long_description" ></textarea>
				            </div>
				            <div class="form-group">
