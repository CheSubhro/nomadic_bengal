				...
				<div class="template-demo">
					<nav aria-label="breadcrumb">
						<ol class="breadcrumb breadcrumb-custom bg-inverse-primary">
				            ...
				            <li class="breadcrumb-item"><a href="javascript:void(0)" style="text-decoration: none">CMS</a></li>
				            <li class="breadcrumb-item active" aria-current="page"><span>All CMS</span></li>
						</ol>
					</nav>
				</div>
				<a href="<?php echo base_url();?>superpanel/cms/add"><button type="button" class="btn btn-outline-success btn-sm" id="add_new">Add New</button></a>
			</div>
		</div>
		<div class="card">
			<div class="card-body">
						...
						<table id="order-listing" class="table">
							...
							<tbody>
								...
								<tr>
									<td><?= $i;?></td>
                    				<td><?= $c->page_name;?></td>
                    				<td><img src="<?= $c->image;?>"alt="<?= $c->image;?>" class="img-lg rounded" style="width:160px;height:100px;"></td>
									...
									<td>
										<a href="<?= base_url();?>superpanel/cms/edit/<?=$c->id;?>"><button type="button" class="btn btn-outline-primary btn-sm">Edit</button></a>
									</td>
								</tr>
								<?php $i++; }?>
							</tbody>
 	...
 	<div class="modal-dialog modal-lg" role="document">
    	<div class="modal-content">
      		<div class="modal-header">
		        <h5 class="modal-title" id="exampleModalLabel"><strong>View CMS</strong></h5>
        		...
        		<div class="row center-block">
          			<div class="col-md-12">
            			<div class="form-group row">
              				...
              				<div class="col-md-6">
              					<label class="col-sm-3 col-form-label"><b>Page Title</b></label>
	                            <div class="col-sm-9">
	                                <div class="form-control"><?=$c->page_title?></div>
	                            </div>
              				</div>
              				<div class="col-md-6">
              					<label class="col-sm-3 col-form-label"><b>Description</b></label>
	                            <div class="col-sm-9">
	                                <div class="form-control"><?=$c->description ?></div>
	                            </div>
              				</div>
              				<div class="col-md-6">
